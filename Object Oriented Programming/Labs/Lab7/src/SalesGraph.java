...
public class SalesGraph extends JFrame implements ActionListener {
	...
	/**
	 * This method creates the introduction menu which provides a button to show
	 * the graph
	 */
	public SalesGraph() {
		super("Bar Chart");
	...
	/**
	 * This method handles the event after clicking our `Show Graph` button
	 * created
	 */
	...
	/**
	 * This is our driver method that creates an instance of `SalesGraph`
	 *
	 * @param args
	 */
